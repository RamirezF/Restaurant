...
public class CanPastaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_can_pasta);
    ...
    private void getData()
    {
        ...
        String pizzaName = extras.getString("PastaName");
        double precio = extras.getDouble("PastaPrecio");
        String pizzaDescripction = extras.getString("PastaDescription");
        int pizzaImage = extras.getInt("PastaImage");
