...
public class CanPromoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_can_promo);
    ...
    private void getData()
    {
        ...
        String pizzaName = extras.getString("PromoName");
        double precio = extras.getDouble("PromoPrecio");
        String pizzaDescripction = extras.getString("PromoDescription");
        int pizzaImage = extras.getInt("PromoImage");
